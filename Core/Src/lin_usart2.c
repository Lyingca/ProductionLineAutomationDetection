...
{
	//响应数组
	uint8_t RS232_Resp_Result[RS232_MAXSIZE] = {0x00,chip_Num,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D};
	//电机转动步长
    ...
    uint8_t Checked_EXV_SW_Version = pLINRxBuff[7] & EXV_SW_VERSION_MASK;
    RS232_Resp_Result[5] = Checked_EXV_SW_Version;
    //检查LIN是否正常通信
